...
class Info:
    ...
    def dataPublish(self):
        ...
        sleep(5)
        self.driver.find_element('id', 'checkbox1C').click()
        sleep(3)
            ...
            for i in range(2, 10):
                ...
                for j in range(1, 11):
                    ...
                    try:
                        ...
                        # Volta para a janela ohttps://github.com/fernandoadc/crawler_cnpq.gitriginal
        ...
        df.to_csv('nova_coleta/ids1C_page_9.csv')
